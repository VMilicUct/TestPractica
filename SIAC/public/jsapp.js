    ...
    try {
      if (true) {
        for (let head = this.subsHead; head; head = head.nextSub) {
          if ( true && head.sub.onTrigger && !(head.sub.flags & 8)) {
            head.sub.onTrigger(
              (0,_vue_shared__WEBPACK_IMPORTED_MODULE_0__.extend)(
                {
                  effect: head.sub
...
function renderList(source, renderItem, cache, index) {
  ...
  if (sourceIsArray || (0,_vue_shared__WEBPACK_IMPORTED_MODULE_1__.isString)(source)) {
    ...
    for (let i = 0, l = source.length; i < l; i++) {
      ret[i] = renderItem(
        sourceIsReactiveArray ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.toReactive)(source[i]) : source[i],
        i,
        void 0,
        cached && cached[i]
      );
...
function doWatch(source, cb, options = _vue_shared__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ) {
  ...
  if (isInSSRComponentSetup) {
    if (flush === "sync") {
      ...
      return {
        stop: _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP,
        resume: _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP,
        pause: _vue_shared__WEBPACK_IMPORTED_MODULE_1__.NOOP
      };
    }
  }
  const instance = currentInstance;
...
function useTemplateRef(key) {
  ...
  return  true ? (0,_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__.readonly)(r) : 0;
}
...
/***/ "./resources/js/components/componentejemplo.vue":
/*!******************************************************!*\
  !*** ./resources/js/components/componentejemplo.vue ***!
  \******************************************************/
/***/ (() => {
...
vue.component('dashboard', (__webpack_require__(/*! ./components/componentejemplo.vue */ "./resources/js/components/componentejemplo.vue")["default"]));
var app = new VueElement({
  el: '#app',
  data: {
    menu: 0
  }
