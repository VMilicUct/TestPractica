              ...
              <ul class="nav-menus">
                      ...
                      <li class="toast default-show-toast align-items-center border-0 fade show" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                        <div class="d-flex justify-content-between">
                          <div class="toast-body d-flex p-0">
                            ...
                            <div class="flex-grow-1"> <a href="../template/private-chat.html">
                ...
                <li class="onhover-dropdown">
                  ...
                  <div class="onhover-show-div notification-dropdown">
                    ...
                    <ul class="messages">
                      ...
                      <li class="bg-transparent"><a class="f-w-700 btn btn-primary w-100" href="../template/letter-box.html">View all</a></li>
                    </ul>
                  </div>
                </li>
                <li class="cart-nav onhover-dropdown">
                  ...
                  <div class="cart-dropdown onhover-show-div">
                    ...
                    <ul>
                      ...
                      <li class="text-center"><a class="d-block view-cart f-w-700 btn btn-primary w-100" href="../template/cart.html">View Cart</a><a class="btn btn-primary view-checkout w-100 f-w-700" href="../template/checkout.html">Checkout</a></li>
                    </ul>
                  </div>
                </li>
                <li class="profile-nav onhover-dropdown px-0 py-0">
                  ...
                  <ul class="profile-dropdown onhover-show-div">
                    ...
                    <li><a href="../template/letter-box.html"><i data-feather="mail"></i><span>Inbox</span></a></li>
                    <li><a href="../template/task.html"><i data-feather="file-text"></i><span>Taskboard</span></a></li>
                    <li><a href="../template/edit-profile.html"><i data-feather="settings"></i><span>Settings</span></a></li>
